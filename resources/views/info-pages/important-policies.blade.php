    ...
    <section class="info-section">
        <div class="width-limiter">
            ...
            <div class="i-section-right">
                <p>This page outlines the policies and procedures governing the operations of STRIKE Bowling Academy. These policies are designed to ensure the safety, well-being, and enjoyment of all students and parents. Please read these policies carefully to ensure compliance.</p>
            </div>
        </div>
    </section>
