...
<main>
    <form class="edit-form width-limiter" style="max-width: 720px">
        ...
        <section class="form-section">
            ...
            <div class="input-group">
                <input required="true" type="text" name="position" autocomplete="off" id="positionInput"
                    class="input">
        ...
        <section class="form-section">
            ...
            <div class="radio-vertical">
                <label class="radio-button">
                    <input type="radio" name="employmentType" value="full-time" {{ $shift === 'full-time' ? 'checked' : '' }}>
                    <div class="radio-circle"></div>
                    <span class="radio-label">Full-time</span>
                </label>
                <label class="radio-button">
                    <input type="radio" name="employmentType" value="part-time" {{ $shift === 'part-time' ? 'checked' : '' }}>
                    <div class="radio-circle"></div>
