    ...
    <form class="edit-form width-limiter">
        ...
        <section class="form-section flex-col">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="heading" autocomplete="off" id="landingHeadingInput" class="input"
                    rows="3"></textarea>
        ...
        <section class="form-section flex-col">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="sub-heading" autocomplete="off" id="landingParagraphInput"
        ...
        <section class="form-section">
            <div class="input-group file">
                ...
                <input required="" type="file" name="image" accept="image/png, image/jpeg, image/webp"
