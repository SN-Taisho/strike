...
<main style="background-color: var(--softwhite);">
    ...
    <form action="{{ route('programmes.update',['programme' => $programme['id'] ]) }}" class="edit-form width-limiter" style="max-width: 720px" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <section class="form-section">
            <div class="input-group">
                <input required="true" type="text" name="name" autocomplete="off" id="titleInput" class="input" value="{{ $programme['name'] }}">
        ...
        <section class="form-section">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="subheading" autocomplete="off" id="briefDescriptionInput" class="input"
                    rows="5">{{ $programme['subheading'] }}</textarea>
        ...
        <section class="form-section">
            <div class="input-group file">
                ...
                <input type="file" name="image" autocomplete="off" id="imageInput" class="input">
            </div>
        </section>

        <div class="details-header width-limiter">
            <img id="image1"
                src="{{ asset('storage/' . $programme->image->link) }}"
                alt="Programme image">
        </div>
        ...
        <section class="form-section">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="description" autocomplete="off" id="mainDescriptionInput" class="input"
                    rows="5">{{ $programme['description'] }}</textarea>
        ...
        <section class="form-section">
            ...
            <div class="input-group">
                <input required="true" type="text" name="age" autocomplete="off" id="ageRangeInput"
                    class="input" value="{{ $programme['age'] }}">
            ...
            <div class="input-group">
                <input required="true" type="text" name="req_skill" autocomplete="off" id="skillReqInput"
                    class="input" value="{{ $programme['req_skill'] }}">
        ...
        <section class="form-section">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="other_info" autocomplete="off" id="otherInfoInput" class="input"
                    rows="3">{{ $programme['other_info'] }}</textarea>
                <label class="label">Write Here</label>
            </div>
        </section>

        <div class="justify-evenly flex-wrap">
            <button type="button" class="cancel-btn trans-ease-in-out" onclick="window.location.href='/programmes'">Cancel</button>
    ...
    <div class="details-header width-limiter">
        ...
        <div class="dh-content">
            ...
            <p id="briefDescription" class="sFont">
    ...
    <div class="width-limiter details-content">
        ...
        <ul class="tags">
            ...
            <li>
                ...
                <p id="ageRange">{{ $programme['age'] }} years old</p>
            </li>
            ...
            <li>
                ...
                <p id="skillReq">{{ $programme['req_skill'] }}</p>
            </li>
        </ul>
    </div>
