...
<main style="background-color: var(--softwhite);">
    ...
    <form action="{{ route('programmes.store') }}" class="edit-form width-limiter" style="max-width: 720px" method="POST" enctype="multipart/form-data">
        ...
        <section class="form-section">
            <div class="input-group">
                <input type="text" name="duration" autocomplete="off" id="durationInput"
                    class="input">
                <label class="label">Duration</label>
            </div>

            <div class="input-group">
                <input type="text" name="age" autocomplete="off" id="ageRangeInput"
                    class="input">
                <label class="label">Age Range</label>
            </div>

            <div class="input-group">
                <input type="text" name="price" autocomplete="off" id="priceInput" class="input">
                <label class="label">Price</label>
            </div>

            <div class="input-group">
                <input type="text" name="req_skill" autocomplete="off" id="skillReqInput"
                    class="input">
        ...
        <section class="form-section">
            ...
            <div class="input-group fill">
                <textarea type="text" name="other_info" autocomplete="off" id="otherInfoInput" class="input"
                    rows="3"></textarea>
                <label class="label">Write Here</label>
            </div>
        </section>
