@include('admin.components.admin-head', ['title' => 'Photo Editor'])
...
<main style="background-color: var(--softwhite);">
    ...
    <form class="edit-form width-limiter" style="max-width: 720px">
        <h1 class="section-heading">Edit Photo Details</h1>
        ...
        <div class="justify-evenly flex-wrap">
            ...
            <button type="submit" class="submit-btn trans-ease-in-out">Update Photo</button>
        </div>
    </form>
