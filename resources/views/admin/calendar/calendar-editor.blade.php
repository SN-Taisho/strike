...
<main style="background-color: var(--softwhite);">
    ...
    <form class="edit-form width-limiter">
        <h3 class="section-heading">Calendar Events Management</h3>
        ...
        <a href="/add-calendar-event" id="openModal" class="action-btn alt text-deco-none" style="margin: auto;">Add New Calendar
            Event</a>
                ...
                <tbody>
                    ...
                    @foreach ($year as $month)
                        <tr>
                            ...
                            <td data-label="Location" class="limit-text">Event Lorem ipsum dolor sit amet consectetur
                                adipisicing elit.
                                Ipsam dolores corporis sapiente soluta. Facere nam quo reiciendis expedita rem possimus
                                cum sit iusto a eum. Illo illum ex unde repudiandae. lorem</td>
    ...
    <h2 class="section-heading">Calendar of Events Preview</h2>
    ...
    <section class="info-section">
        <div class="width-limiter">
            ...
            <div class="i-section-right">
                <p id="briefDescription">Our calendar is brimming with engaging activities, from captivating workshops
                    to exhilarating competitions. Whether you're seeking knowledge, entertainment, or camaraderie, our
