@include('admin.components.admin-head', ['title' => 'Add Bowlers Achievement'])

@include('admin.components.admin-header')

<main style="background-color: var(--softwhite);">

    <form action="{{ route('bowlers.store') }}" class="edit-form width-limiter" style="max-width: 720px" method="POST">
        @csrf
        <h1 class="section-heading">Add Bowlers Achievement</h1>

        <section class="form-section">
            <div class="input-group">
                <input required="true" type="text" name="tournament_name" autocomplete="off" id="titleInput" class="input">
        ...
        <section class="form-section">
            <div class="input-group">
                <input required="true" type="text" name="tournament_category" autocomplete="off" id="categoryInput"
                    class="input">
        ...
        <section class="form-section">
            ...
            <div class="input-group fill">
                <textarea required="" type="text" name="description" autocomplete="off" id="contentInput" class="input"
                    rows="5"></textarea>
        ...
        <input id="listOutput" type="text" name="runner_ups" type="hidden" style="display: none;">
